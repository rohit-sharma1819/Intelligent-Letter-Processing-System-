...
<body>
    ...
    <main class="main-content">
        <!-- Add New Letter Card -->
        <div class="card add-letter">
            <span class="material-icons">post_add</span> <!-- Google Material Icon -->
            <h2>Add New Letter</h2>
            <p>Create and manage new letters efficiently.</p>
            <!-- <a href="add-letter.html">Add Letter</a> -->
            <a href="add_letter1.php">Add Letter</a>

        </div>

        <!-- View Letters Card -->
        <div class="card view-letters">
            <span class="material-icons">visibility</span> <!-- Google Material Icon -->
            <h2>View Letters</h2>
            <p>Access and track all letters effortlessly.</p>
            <a href="view_letter.php">View Letters</a>
        </div>
    </main>
